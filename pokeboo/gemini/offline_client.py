...
When `POKEBOO_MODE=offline` is set, `get_gemini_client()` returns an instance
...
def _interpreter_response(system_prompt: str, user_prompt: str) -> dict[str, Any]:
    """Generate a friendly canned PokeBo message.
...
class OfflineGeminiClient:
    ...
    def __init__(self, settings: Settings):
        ...
        logger.info(
            ...
            "Set POKEBOO_MODE=online and GEMINI_API_KEY to enable real LLM calls."
        )
