...
from ..contracts.messages import AgentProposal, PokeBoEvaluation, STTPayload
...
class STTAgent:
    ...
    async def revise(self, evaluation: PokeBoEvaluation, **original_kwargs: Any) -> AgentProposal:
