...
Creates/updates/deletes events from PoKeBoo's scheduled tasks.
"""
...
class CalendarClient:
    """Wraps Google Calendar API for PoKeBoo's use.

    All events go to a single calendar (default: 'primary').
    Event IDs are stored as task IDs prefixed with 'pokeboo-' to avoid collisions
