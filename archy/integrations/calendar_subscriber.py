"""Calendar subscriber — listens to Archy events and syncs them to Calendar.

This is an optional subscriber. Enable via `ARCHY_CALENDAR_SYNC_ENABLED=true`.
...
class CalendarSubscriber:
    """Subscribes to Archy events and pushes them to Google Calendar.
