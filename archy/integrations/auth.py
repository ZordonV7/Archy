...
as JSON at `~/.archy/google_tokens.json` and auto-refreshed when they expire.
...
1. CLI flow (desktop): `run_flow()` — opens browser, captures callback on
   localhost:8765. Used by `archy auth` CLI command.
    ...
    def get_auth_url(self, redirect_uri: str, state: str = "") -> str:
        ...
        Args:
            redirect_uri: The backend's callback URL (must be registered in
                ...
                "https://archy-backend.onrender.com/auth/google/callback"
