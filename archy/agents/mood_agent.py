...
- `recommendations`: list of short actionable strings for the manager (Archy) to consider (e.g., "reduce next slot to 25 minutes", "acknowledge progress before next task").
