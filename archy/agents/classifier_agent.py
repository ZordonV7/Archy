...
from ..contracts.messages import AgentProposal, ClassificationPayload, ArchyEvaluation
...
You may receive `constraints` from the manager (Archy) asking you to adjust.
...
class ClassifierAgent:
    ...
    async def revise(self, evaluation: ArchyEvaluation, text: str, **_: Any) -> AgentProposal:
        # Re-run with Archy's constraints merged in.
