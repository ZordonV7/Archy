"""Archy's interpreter — structured agent data → user-facing speech.

This is the ONLY place natural language for the user is generated. All
agents emit JSON; only Archy (via this module) produces prose.

Uses the Pro model for richer reasoning — Archy's voice is the product.
"""
...
class Interpreter:
    """Translates structured agent outputs into Archy's user-facing speech."""
    ...
    async def synthesize(
        ...
        *,
        ...
        """Produce 1-3 sentences of Archy's speech for the given event.
        ...
        user_prompt = (
            ...
            f"Respond as Archy. ONE sentence. Max 15 words. Match tone to mood. No technical terms. "
        ...
        try:
            data = await self._client.generate_json_with_fallback(
                ...
                operation_name="Archy speech synthesis",
            )
